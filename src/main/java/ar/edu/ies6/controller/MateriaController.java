...
public class MateriaController {
	...
	public ModelAndView getWithMaterias() {
		...
		transportador.addObject("listaAlumnos", alumnoService.listarTodosAlumnosActivos());
...
//MateriaServiceImp materiaService = new MateriaServiceImp ();
	...
	@GetMapping("/listarAlumnosDeLaMaterias/{codigo}")
	public ModelAndView listarAlumnosDeLaMateria(@PathVariable(name = "codigo") String codigo) {
		// buscar
		Materia materiaAlistar = materiaService.consultarMateria(codigo);
		// mostrar el nuevo listado de alumno
